...
In 2019 I started my position at TU Delft as a lecturer/innovator (docent 2) of two lab courses: the _First Year Physics Lab Course (FYPLC)_ and _Introduction to Experiments in Physics_, a course for the minor modern physics.
...
- Introduction of a new practicum on determining _g_ with 0.1% accuracy.
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/sgo-0ba7168d363ab6a14f1419801de2f1d4.png", width: 95%),
  caption: [
Some of the current labs are formatted in the SGO structure, a two page prestructured lab journal #cite(<pols2024scientific>). Here only the front is shown.
],
  kind: "figure",
  supplement: [Figure],
) <fig_sgo>
...
#let body = [Over the years my involvement has further increased, contributing (e.g.) to the development of a new course (implementation of education) - where students ought to consider the merits and trade-offs of different educational approaches (like doing an #link("https://freekpols.github.io/EscapeTheClassroom/")[educational escaperoom]) and test it in their own class.

With the upcoming retirement of the main physics teacher educator, my involvement in the program has increased, e.g. in supervising master thesis projects. Related to my engagement in the program is my senior university teaching qualification (SUTQ) project. The SUTQ project focused on _The development of a learning pathway on scientific inquiry in the teacher-education program_. ]
#wrap-content(fig, body, align: right, gutter: 1em)
#v(-1.3em)
The teacher education program lacked a coherent teaching sequence on educational research whilst students of the two year masters program were still expected to do a research project. Moreover, the various teachers involved seem to have different opinions about the role and nature of educational research in the program. In the SUTQ project (2025-2026) I addressed _why, what, when, by whom, and how we are teaching educational research in TU Delft's teacher-education program_. This project has led to a blueprint for a learning pathway which is currently further developed and implemented. A scientific manuscript has been submitted #cite(<pols2026TvL>).

== An educationalist with (pedagogical) content knowledge <educationalist>

At our university, we have many educationalists (onderwijskundigen). They are a great asset in many ways as they possess strong knowledge of education in general and can therefore support educators in designing their courses. However, when content-specific questions arise, this becomes more challenging as educationalists often do not have in-depth knowledge of, for example, quantum mechanics, coding, or fluid mechanics - commonly referred to as _content knowledge_. While they may know in general what an assessment should look like, operationalizing this within a specific context, such as a Python course, can be difficult. Moreover, many lack any teaching experience themselves.

Conversely, our researchers have extensive knowledge of the subjects they teach. However, this does not necessarily imply that they know how to teach that subject effectively - referred to as _pedagogical content knowledge_ #cite(<Van_Driel_2010>).

In this context, I position myself at the intersection of these domains. I can be considered an educationalist - conversant with educational literature - but with both content knowledge and pedagogical content knowledge. I understand how lab courses can be designed and why certain measures/approaches work or do not work. I focus on teaching labs, but also teach introductory Python and I am becoming increasingly engaged in the pedagogy of teaching quantum mechanics (see next chapter). Many other physics related topics I have thought (albeit at a different level) and I thus know the struggles students are coping with. Deep knowledge of both education and physics allows me to interpret student responses in a content-informed way, e.g., when asking a student _"why is an electron not a particle (or equally valid, not a wave)?"_, I can assess not only the correctness of the answer but also what it reveals about their understanding of the dual nature of the electron.

This combination of expertise (physics and education) enables me to support colleagues in translating general educational principles into discipline-specific practice. As a result, I am frequently consulted by researchers on educational questions. Examples include Gary Steele on the renewal of the Electronic Instrumentation course, Roel Smit on curriculum coherence, Margreet Docter on implementing a Just-In-Time-Teaching approach #cite(<novak1999just>) for the NB Electronics course, Erik van der Kolk on the renewal of the second-year lab course, and Rolf Hut in e.g. the swift transition to remote teaching with Covid, among others. Importantly, this role extends beyond our faculty's educational programs: I am also consulted by colleagues in Aerospace Engineering, Mechanical Engineering, and Civil Engineering.
...
== Vision statement on education <visiononeducation>

*Philosophy:* My philosophy in and on education is that I want students to develop (in a structured way) a sense of what (scientific) quality entails. For teaching in the first year physics lab course, this means that I want students to learn how to make well-considered choices throughout the research process. There is no single method in science, and there are no set procedures that always lead to the best result. The question at the core is _What decision leads to the best result in the given circumstances?_ Hence, rather than telling students what to do - or let them following a recipe - they should consider the quality of their choices and actions throughout the process and, ultimately, be able to argue why their decision is defensible in light of the constraints at that specific moment in time. #footnote[I will come back to this in my research section.]
...
I believe that the above demonstrates that I am not only able to teach physics at different educational levels but also that I possess the skills and experience to innovate educational programs in a sustained and systematic manner, both at the level of individual courses and at the level of the curriculum, both in the physics and in the teacher-education program. Furthermore, my work extends beyond teaching and local educational practice. I actively contribute to the development of education by disseminating insights, materials, and results through professional and academic journals, as well as through national and international conferences (see #link("/appendixa")[Appendix A]). In doing so, I connect educational practice with scholarly reflection and contribute to the broader community of physics and physics education educators. Taken together, these activities reflect my readiness to take on greater responsibility and leadership in education, in line with the role and expectations of an associate professor with an emphasis on education.